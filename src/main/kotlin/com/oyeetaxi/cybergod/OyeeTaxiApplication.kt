...
class OyeeTaxiApplication:CommandLineRunner{
	...
	@Autowired
	val actualizacionRepository: ActualizacionRepository? = null
	...
	fun populateBD(){
		...
		val appUpdateList : MutableList<Actualizacion> = emptyList<Actualizacion>().toMutableList()
		...
		with(appUpdateList) {
			add(
				Actualizacion(
					...
					versionString = "1.0",
					fileSize = "10 MB",
					appURL = "ficheros/descarga/123.apk",
					playStorePackageName = "" ,
					forceUpdate = true,
					description = listOf<String>("- Lanzamiento de la App Beta")
				)
			)
			add(
				Actualizacion(
					...
					fileSize = "20 MB",
					appURL = "ficheros/descarga/123.apk",
					playStorePackageName = "com.ubercab&hl=es_419&gl=US" ,
					forceUpdate = false,
		...
		actualizacionRepository!!.saveAll(appUpdateList)
...
//			imagenFrontalPublicaURL = "ficheros/descarga/AUTO_MOVIL_1.PNG",
//			vehiculoVerificacion = VehiculoVerificacion(
//				verificado = true,
//				circulacion = "C8952410",
//				imagenCirculacionURL = "ficheros/descarga/6AEFC655-3FAB-4C7E-98C2-62CA10002779_USUARIO_VERIFICACION_20220604111628.JPG",
//				matricula = "P525700",
//			)
//		).also {
...
//			disponible = true,
//			climatizado  = true,
//			fechaDeRegistro = LocalDate.parse("08-08-2022", myformatter),
